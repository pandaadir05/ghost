...
Usage:
    from NeuralMemory import analyze_file, get_api
...
__url__ = "https://github.com/poppopjmp/NeuralMemory"
...
NeuralMemoryOrchestrator = Orchestrator
VMAnalysisAPI = NeuralMemoryAPI
