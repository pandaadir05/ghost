...
"""
NeuralMemory Quick Start Script
===============================

Simple script to quickly start NeuralMemory with automatic dependency handling.
...
def main():
    ...
    print("🐉 NeuralMemory Quick Start")
    print("=" * 40)
    ...
    print("🚀 Starting NeuralMemory...")
    try:
        import dragonslayer
        from dragonslayer import get_api

        print(" NeuralMemory loaded successfully!")
