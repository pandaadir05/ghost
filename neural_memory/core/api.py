...
"""
NeuralMemory Core API
======================

Core API interface that provides a unified, clean interface to all
NeuralMemory functionality without development artifacts.
"""
...
class NeuralMemoryAPI:
    """
    Unified API for NeuralMemory functionality.

    This class provides a clean, production-ready interface to all
    NeuralMemory capabilities without development artifacts or
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.logger.info("NeuralMemory API initialized")
    ...
    async def shutdown(self) -> None:
        ...
        try:
            self.logger.info("Shutting down NeuralMemory API...")
            await self.orchestrator.shutdown()
            self._initialized = False
            self.logger.info("NeuralMemory API shutdown complete")
...
def get_api(config_path: Optional[str] = None) -> NeuralMemoryAPI:
    """Get global API instance"""
    global _api_instance
    if _api_instance is None:
        _api_instance = NeuralMemoryAPI(config_path)
