...
"""
NeuralMemory Core Configuration Management
==========================================

Centralized configuration management for the NeuralMemory system.
...
class NeuralMemoryConfig:
    """Main NeuralMemory system configuration"""
...
class ConfigManager:
    """Centralized configuration manager for NeuralMemory"""
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self._config = NeuralMemoryConfig()
        self._loaded = False
    ...
    def _find_config_file(self) -> Optional[str]:
        ...
        search_paths = [
            "NeuralMemory_config.yml",
            "config/NeuralMemory_config.yml",
            "config/config.yml",
            os.path.expanduser("~/.NeuralMemory/config.yml"),
            "/etc/NeuralMemory/config.yml",
        ]
    ...
    def save(self, config_path: Optional[str] = None) -> None:
        ...
        """
        save_path = config_path or self.config_path or "NeuralMemory_config.yml"
    ...
    @property
    def config(self) -> NeuralMemoryConfig:
...
def get_config(config_path: Optional[str] = None) -> NeuralMemoryConfig:
    """Get current configuration"""
