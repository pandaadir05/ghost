...
from ..core.api import NeuralMemoryAPI
...
class APIServer:
    """
    Unified REST API server for NeuralMemory.

    Provides a comprehensive HTTP API for all NeuralMemory functionality
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        # Initialize core API
        self.vmds_api = NeuralMemoryAPI(config_path)

        # Initialize FastAPI app
        self.app = FastAPI(
            title="NeuralMemory API",
